...
namespace WpfApp1 {
    ...
    public partial class Database2DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(int Id, string ad, string soyad, string marka, string model, string yil, string gsm, string km, string plaka, string grup, string motorNo, string sasiNo, string aciklama, string fiyat, string tarih) {
            ...
            private void InitClass() {
                ...
                this.columnmotorNo.MaxLength = 30;
                this.columnsasiNo.MaxLength = 30;
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string fiyat {
                get {
                    try {
                        return ((string)(this[this.tableTable.fiyatColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace WpfApp1.Database2DataSetTableAdapters {
...
SELECT Id, ad, soyad, marka, model, yil, gsm, km, plaka, grup, motorNo, sasiNo, aciklama, fiyat, tarih FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WpfApp1.Properties.Settings.Default.Database2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        ad, soyad, marka, model, yil, gsm, km, plaka, grup, motorNo, sasiNo" +
                ", aciklama, fiyat, tarih, Id\r\nFROM            [Table]";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Id, ad, soyad, marka, model, yil, gsm, km, plaka, grup, motorNo, sasiNo, a" +
                "ciklama, fiyat, tarih FROM [Table]";
        ...
        public virtual int ARA___(Database2DataSet.TableDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy(Database2DataSet.TableDataTable dataTable) {
